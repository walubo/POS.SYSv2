<x-app-layout>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <div class="flex gap-2 mt-1">
                                <x-text-input id="sku" class="block w-full" type="text" name="sku" :value="old('sku')" placeholder="e.g. 10293847" />
    ...
    <script>
        function generateSKU() {
            // Generate a random 8-digit numeric product code
            const code = Math.floor(10000000 + Math.random() * 90000000).toString();
            document.getElementById('sku').value = code;
            document.getElementById('sku').focus();
        }

        // Auto-generate if SKU is empty on page load
